...
<form action="/main/process" method="post">
	...
	addr1 : <input type="text" name="addr[0].addr1" value="대전시 중구"/><br>
	addr2 : <input type="text" name="addr[0].addr2" value="중앙로76"/><br>
	
	addr1 : <input type="text" name="addr[1].addr1" value="대전시 중구"/><br>
	addr2 : <input type="text" name="addr[1].addr2" value="중앙로76"/><br>
